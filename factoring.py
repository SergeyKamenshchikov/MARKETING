...
print('----------------------------')
print('<Forest>:')
print('mean_score_traffic:'+str(mylib.forest(df_traffic,Target)[0]))
print('mean_score_retention:'+str(mylib.forest(df_retention,Target)[0]))
...
s.append(mylib.forest(df_retention,Target)[0]-mylib.forest(df_traffic,Target)[0])#forest
...
c=mylib.forest(df_retention,Target)[1]
...
c=mylib.forest(df_traffic,Target)[1]
